...
print(str(smart_contract_pundix_balance), pundix_symbol)
...
print(str(smart_contract_usdt_balance), usdt_symbol)
...
print(str(smart_contract_weth_balance), weth_symbol)
...
print(str(smart_contract_dai_balance), dai_symbol)
